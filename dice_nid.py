...
class check_ji_nid:
    ...
    def collect(self,gtPath, predPath):
        ...
        for i in range(len(gtlist)):
            ...
            # open .nii label
            predlist[i] = (predlist[i] + '/liver_nid.nii').replace("\\", "/")
            gtlist[i] = (gtlist[i] + '/liver_nid.nii').replace("\\", "/")
    ...
    def evaluate(self,gt, pred, name, csvpath):
        ...
        df_avg.to_csv(os.path.join('./result',csvpath, 'average_nid.csv'), encoding='utf-8')
